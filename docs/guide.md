...
- ゲーム別の設定と進め方
  ...
  - [B. あなたも含めて均等にローテーション（1対1）](#b-あなたも含めて均等にローテーション1対1)
  - [C. 視聴者があなたに挑戦する（1対1）](#c-視聴者があなたに挑戦する1対1)
  - [D. 2対2 の対戦ゲーム](#d-2対2-の対戦ゲーム)
  - [E. エルデンリング / ダークソウル（協力プレイ）](#e-エルデンリング--ダークソウル協力プレイ)
  - [F. 地球防衛軍（協力プレイ）](#f-地球防衛軍協力プレイ)
...
**対戦ゲームでのあなた（配信者）の参加のしかた** は 4 通りから選べます。進行画面の上部の「配信者」で、配信中でもいつでも切り替えられます。

| 配信者の設定 | どうなるか | 例 |
|---|---|---|
| 参加しない | 視聴者同士で対戦。あなたは進行・実況に専念 | [A](#a-1対1の対戦ゲーム視聴者同士) |
| **列に並ぶ** | あなたも視聴者と同じ順番待ちに並ぶ。ローテーションなら全員に均等に出番 | [B](#b-あなたも含めて均等にローテーション1対1) |
| 毎試合出る | 毎試合あなたが出て、視聴者が 1 人ずつ（2対2 なら相方と相手が）入れ替わる | [C](#c-視聴者があなたに挑戦する1対1) |
| 勝ち抜きの王者役 | あなたが勝ち続ける限り残る。負けたら勝った視聴者が王者に、あなたは列の最後尾へ | [C](#c-視聴者があなたに挑戦する1対1) |
...
### B. あなたも含めて均等にローテーション（1対1）

**あなたも視聴者と同じ順番待ちに並び、全員に均等に出番が回る** 形です。あなたの番が来たら、あなたも対戦します。
...
![あなたも含めたローテーションの進行画面](images/guide/host-rotation-dash.png)

- 「配信者」を **列に並ぶ** にすると、待機列に「配信者（あなた）」が視聴者と一緒に並びます（「あなた」の印が付きます）
- 列の先頭 2 人が対戦し、終わったら 2 人とも最後尾へ。一巡すると、またあなたの番が来ます
- 進め方を **勝ち抜き** にすると、あなたも普通の参加者として勝ち抜き戦に混ざります（勝てば残り、負ければ最後尾）
- 自分の番を後回しにしたい時は、待機列の「配信者」をドラッグで後ろへ。休憩したい時は ✕ で列から外し、戻る時は進行画面上部の「配信者を列に入れる」を押します

> **チャットで自分が `!参加` しなくて大丈夫です。** あなたが自分のチャンネルで `!参加` すると「配信者」とは別の参加者として登録されるので、「配信者：列に並ぶ」を使ってください。
...
- **列に並ぶ** にすると、あなたも視聴者と同じ順番待ちに入ります（[B. 均等ローテーション](#b-あなたも含めて均等にローテーション1対1)）
...
| 人数 | 2対2 |
| 進め方 | 勝ち抜き／ローテーション |
| 配信者 | 参加しない（あなたも入るなら「毎試合出る」か「列に並ぶ」） |
...
- 「配信者：列に並ぶ」にすると、あなたも列の順番どおりにチームに入ります（ローテーションなら全員に均等に出番が回ります）
- 1 人だけ来ない時は、その人の「不在 → 交代」で列の先頭の人が同じチームに入ります

---

### E. エルデンリング / ダークソウル（協力プレイ）
